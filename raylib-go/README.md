## NOTICE
This is a clone of this excelent [repo](https://github.com/gen2brain/raylib-go) written by [gen2brain](https://github.com/gen2brain).

And it is certainly not written by me lol.

It was cloned here because I wanted to add some more bindings for fnf-practice

And I thought it would be easiser to clone and modify it locally rather than forking it to my own github repo
